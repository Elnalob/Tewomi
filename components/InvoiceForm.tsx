    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="bg-white rounded-xl shadow-sm border p-6 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setInvoice({ ...invoice, business: { ...invoice.business, accountNumber: e.target.value } })}
                    className="w-full p-2 border rounded"
                  />
                </div>
              </div>
        ...
        <div className="flex flex-col items-end pt-8 space-y-2 border-t">
          ...
          <div className="flex justify-between w-64 text-xl font-bold text-gray-900 pt-2">
            <span>Total</span>
